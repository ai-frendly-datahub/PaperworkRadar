...
StorageError = cast(type[Exception], import_module("paperworkradar.exceptions").StorageError)
...
RadarStorage = cast(_RadarStorageCtor, import_module("paperworkradar.storage").RadarStorage)

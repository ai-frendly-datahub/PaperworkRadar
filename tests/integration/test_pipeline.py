...
<item>
  <title>Filing requirement update</title>
  <link>https://example.com/article-1</link>
  <description>filing demand is up</description>
  <pubDate>Wed, 04 Mar 2026 10:00:00 GMT</pubDate>
</item>
</channel></rss>
"""

    with patch("paperworkradar.collector.requests.get", return_value=_FakeResponse(rss_payload)):
        output_path = run(
            category="test_cat",
